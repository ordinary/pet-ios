...
- (id<PetMenuBarDelegate>)delegate {
...
- (void)setup {
    ...
    _menuBarView = [[PetMenuBarView alloc] initWithFrame:self.bounds];
...
- (id)initWithFrame:(CGRect)frame {
    return [self initWithFrame:frame andStyle:PetMenuBarStyleItem];
}
